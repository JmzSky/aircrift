<template>
  <UiPopup v-model="visible" :closeOnClickModal="closeOnClickModal" position="bottom" class="ui-datetime">
    <UiPicker
      :slots="dateSlots"
      @change="onChange"
      ...
      ref="picker"
      show-toolbar>
      <div class="ui-datetime-action">
        <span class="ui-datetime-cancel" @click="visible = false;$emit('cancel')">{{ cancelText }}</span>
        <span class="ui-datetime-confirm" @click="confirm">{{ confirmText }}</span>
      </div>
    </UiPicker>
  </UiPopup>
</template>
...
.ui-datetime .picker-slot-wrapper, .ui-datetime .picker-item {
  -webkit-backface-visibility: hidden;
          backface-visibility: hidden;
}
.ui-datetime .picker-toolbar {
